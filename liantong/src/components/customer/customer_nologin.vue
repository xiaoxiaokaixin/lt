        ...
        <div class="welcome">
            <div class="center">
                ...
                <div class="noLoginDiv">
                    欢迎来到中国联通！
                    <router-link to="/login" id="pleaseLogin">[登录]</router-link>&nbsp;
            ...
            <div class="center ">
                ...
                <div class="left-side float-left" >
                    ...
                    <ul class="sidebar_nav list-unstyled mt-2">
                        <li><router-link to="/nologinCustomer" class="myorder" >我的订单</router-link></li>
                    ...
                    <h2 class="">我的账户</h2>
                    <ul class="sidebar_nav list-unstyled mt-2">
                        <li><router-link to="/nologinCustomer" class="personinfo" >个人信息</router-link></li>
                        <li><router-link to="/nologinCustomer" class="updatePwd">密码修改</router-link></li>
                        <li><a href="#" >账号绑定</a></li>
                        <li><a href="#" >号码管理</a></li>
                        <li><router-link to="/nologinCustomer" class="address">收货地址</router-link></li>
                ...
                <h5 class="font-weight-bold head">我的订单</h5>
                    <nologin-box></nologin-box>
                </div>
...
<script>
import noLoginOrder from '../state/noLoginOrder.vue'
$(function(){
    $(".sidebar_nav li").click(function(e){
